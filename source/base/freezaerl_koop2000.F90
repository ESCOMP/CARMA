              ...
              if ((inucproc(iepart,ienucto) == I_AERFREEZE) .or. &
                ...
                do ibin = 1, NBIN
                  ...
                  if (ssi > sifreeze) then
                    ...
                    ! NOTE: This can give very large rates, so limit it for stability.
                    rnuclg(ibin,igroup,ignucto) = rnuclg(ibin,igroup,ignucto) + min(1e10_f, rjj * volrat * vol(ibin,igroup))                 ! [s-1]
